...
from .entity import BatteryNoteEntity, BatteryNotesEntityDescription
...
class BatteryNotesTypeSensor(BatteryNoteEntity, RestoreSensor):
...
class BatteryNotesLastReplacedSensor(
    BatteryNoteEntity, SensorEntity
):
