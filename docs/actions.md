...
| <div style="width:200px">Data attribute</div> | Optional | Description                                                                                                          |
| --------------------------------------------- | -------- | -------------------------------------------------------------------------------------------------------------------- |
...
## Check Battery Last Replaced

`battery_notes.check_battery_last_replaced`

For getting a response or raising events for devices that haven't replaced their battery.  
...
| `raise_events`                                | `yes`    | Raise events for for each matching device for use in automation triggers (default true). |

## Check Battery Last Reported
...
For getting a response or raising events for devices that have a battery low status.  
